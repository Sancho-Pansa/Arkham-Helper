package io.sanchopansa.arkham.core.monsters;
...
import io.sanchopansa.arkham.core.AbstractGameElement;
...
public final class Monster extends AbstractGameElement {
    ...
    public Monster(Expansion e,
        ...
        this.abilities = abilities.stream().map(MonsterAbility::valueOf).collect(Collectors.toUnmodifiableList());
        this.flavor = flavor;
    }
